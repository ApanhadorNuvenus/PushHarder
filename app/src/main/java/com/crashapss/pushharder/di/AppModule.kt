package com.crashapss.pushharder.di

import android.app.Application
import androidx.room.Room
import com.crashapss.pushharder.feature_train.data.data_source.TrainDatabase
import com.crashapss.pushharder.feature_train.data.repository.ExerciseRepositoryImpl
import com.crashapss.pushharder.feature_train.data.repository.ExerciseSetRepositoryImpl
import com.crashapss.pushharder.feature_train.data.repository.TrainingExerciseRepositoryImpl
import com.crashapss.pushharder.feature_train.data.repository.TrainingRepositoryImpl
...
import com.crashapss.pushharder.feature_train.domain.use_case.exercise_set_use_cases.AddExerciseSet
import com.crashapss.pushharder.feature_train.domain.use_case.exercise_set_use_cases.DeleteExerciseSet
import com.crashapss.pushharder.feature_train.domain.use_case.exercise_set_use_cases.ExerciseSetUseCases
import com.crashapss.pushharder.feature_train.domain.use_case.exercise_set_use_cases.GetSetsForTrainingExercise
import com.crashapss.pushharder.feature_train.domain.use_case.exercise_use_case.AddExercise
import com.crashapss.pushharder.feature_train.domain.use_case.exercise_use_case.DeleteExercise
import com.crashapss.pushharder.feature_train.domain.use_case.exercise_use_case.ExerciseUseCases
import com.crashapss.pushharder.feature_train.domain.use_case.exercise_use_case.GetExercises
import com.crashapss.pushharder.feature_train.domain.use_case.exercise_use_case.GetExerciseById
import com.crashapss.pushharder.feature_train.domain.use_case.exercise_use_case.UpdateExercise
import com.crashapss.pushharder.feature_train.domain.use_case.training_use_case.AddTraining
import com.crashapss.pushharder.feature_train.domain.use_case.training_use_case.DeleteTraining
import com.crashapss.pushharder.feature_train.domain.use_case.training_use_case.GetAllTrainings
import com.crashapss.pushharder.feature_train.domain.use_case.training_use_case.GetTrainingById
import com.crashapss.pushharder.feature_train.domain.use_case.training_use_case.TrainingUseCases
import com.crashapss.pushharder.feature_train.domain.use_case.training_use_case.UpdateTraining
import com.crashapss.pushharder.feature_train.domain.use_case.trainingExercise_use_case.AddTrainingExercise
import com.crashapss.pushharder.feature_train.domain.use_case.trainingExercise_use_case.DeleteTrainingExercise
import com.crashapss.pushharder.feature_train.domain.use_case.trainingExercise_use_case.GetExercisesForTraining
